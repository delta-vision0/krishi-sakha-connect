...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'preferences.subtitle': 'Customize your farming experience',
    'preferences.tabs.crops': 'My Crops',
    'preferences.tabs.cropsDesc': 'Select your preferred crops',
    'preferences.tabs.profile': 'Profile',
    'preferences.tabs.profileDesc': 'Your farming profile',
    'preferences.tabs.location': 'Location',
    'preferences.tabs.locationDesc': 'Your farm location',
    'preferences.preferredCrops': 'Your Preferred Crops',
    'preferences.preferredCropsDesc': 'Select the crops you grow or are interested in. This helps us provide better recommendations for you.',
    'preferences.manageCrops': 'Manage Crops',
    'preferences.selectCrops': 'Select Your Crops',
    'preferences.selectCropsDesc': 'Choose the crops you grow or are interested in',
    'preferences.searchCrops': 'Search crops...',
    'preferences.selectAll': 'Select All',
    'preferences.clearAll': 'Clear All',
    'preferences.showSelectedOnly': 'Show selected only',
    'preferences.cropsSelected': 'crops selected',
    'preferences.searchResults': 'Search Results',
    'preferences.noResults': 'No crops found',
    'preferences.noCropsSelected': 'No crops selected yet',
    'preferences.clickManageCrops': 'Start by selecting your preferred crops',
    'preferences.farmingProfile': 'Your Farming Profile',
    'preferences.farmingProfileDesc': 'Tell us about your farming experience to get personalized recommendations.',
    'preferences.farmingExperience': 'Farming Experience',
    'preferences.experience.beginner': 'Beginner',
    'preferences.experience.beginnerDesc': 'New to farming',
    'preferences.experience.intermediate': 'Intermediate',
    'preferences.experience.intermediateDesc': 'Some farming experience',
    'preferences.experience.advanced': 'Advanced',
    'preferences.experience.advancedDesc': 'Experienced farmer',
    'preferences.farmSize': 'Farm Size',
    'preferences.size.small': 'Small',
    'preferences.size.smallDesc': 'Less than 2 acres',
    'preferences.size.medium': 'Medium',
    'preferences.size.mediumDesc': '2-10 acres',
    'preferences.size.large': 'Large',
    'preferences.size.largeDesc': 'More than 10 acres',
    'preferences.farmingType': 'Farming Type',
    'preferences.type.organic': 'Organic',
    'preferences.type.organicDesc': 'Natural farming methods',
    'preferences.type.conventional': 'Conventional',
    'preferences.type.conventionalDesc': 'Traditional farming with chemicals',
    'preferences.type.mixed': 'Mixed',
    'preferences.type.mixedDesc': 'Mix of both methods',
    'preferences.farmLocation': 'Your Farm Location',
    'preferences.farmLocationDesc': 'Set your farm location to get location-specific recommendations and weather alerts.',
    'preferences.locationNotSet': 'Location not set',
    'preferences.locationNotSetDesc': 'Your location is automatically detected from the weather widget. You can change it there.',
    'preferences.goToWeather': 'Go to Weather Settings',
